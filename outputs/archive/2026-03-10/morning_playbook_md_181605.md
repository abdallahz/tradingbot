# Morning Trading Playbook
Generated: 2026-03-10T18:16:05.286189Z
...
### 🔍 RECOMMENDED: Option 1: Night Research Catalysts
**Why:** Low volatility market (avg gap 1.1%). Focus on catalyst-driven picks from night research. Wait for news-driven momentum.
...
- **GME** (catalyst=87) | High catalyst score
- **NVDA** (catalyst=67) | High catalyst score
- **MSFT** (catalyst=65) | High catalyst score
- **GOOGL** (catalyst=65) | High catalyst score
- **AMD** (catalyst=65) | High catalyst score
- **PYPL** (catalyst=62) | Gap: -2.2%
...
- No setups even with relaxed filters
...
- No qualified setups with strict filters ✅ (Capital protection mode)